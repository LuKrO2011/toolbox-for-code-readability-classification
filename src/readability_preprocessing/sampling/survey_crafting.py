...
class RDH:
    ...
    def __init__(self, name: str, probability: float, unused_snippets: list[str],
                 stratum):
        """
        Initialize the RDH.
...
class Snippet:
    ...
    def __init__(self, name: str, rdh: RDH):
        """
        Initialize the snippet.
        :param rdh: The rdh the snippet belongs to.
        :param name:
        """
        self.stratum = rdh.stratum
        self.rdh = rdh
        self.name = name
        ...
        for rdh_name in rdh_names[strata_name]:
            rdhs.append(
                RDH(
                    ...
                    unused_snippets=list_non_hidden(
                        os.path.join(input_dir, strata_name, rdh_name)),
                )
            )
        strata.append(
