...
def generate_bar_chart(data: list,
                       headline: str = 'Relative Frequency of "Not Different" Cases') \
    -> None:
    """
...
generate_bar_chart(diff_data,
                   headline='Relative Frequency of "Not Different" Cases Overall')
for stratum in diff_data[1:]:
    generate_bar_chart(stratum["sub_statistics"],
