...
class Submission:
    ...
    def __init__(self, data: dict) -> None:
        ...
        self.time_taken = float(data['Time taken'])
        self.completion_code = data['Completion code']
        self.total_approvals = int(data['Total approvals'])
...
def load_submissions(input_path: str) -> list[Submission]:
    """
...
submissions = load_submissions(DEMOGRAPHIC_DATA_DIR / "p1s0.csv")
