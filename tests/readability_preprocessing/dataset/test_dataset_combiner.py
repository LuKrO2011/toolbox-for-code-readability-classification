...
from src.readability_preprocessing.dataset.dataset_combiner import (
    _load_datasets,
    _remove_ambiguous_samples,
    combine_datasets,
)
from tests.readability_preprocessing.utils.utils import (
    ENCODED_BW_DIR,
    ENCODED_DORN_DIR,
    ENCODED_SCALABRIO_DIR,
    DirTest,
)
...
class DatasetCombinerTest(DirTest):
    ...
    def test_combine_datasets(self):
        combine_datasets(
            [ENCODED_BW_DIR, ENCODED_DORN_DIR, ENCODED_SCALABRIO_DIR], self.output_dir
        )
