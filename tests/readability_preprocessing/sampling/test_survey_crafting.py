...
from readability_preprocessing.sampling.survey_crafting import (
    Method,
    Stratum,
    Survey,
    SurveyCrafter,
...
class TestPermutations(DirTest):
    ...
    def test_permutation_matrix_3(self):
        permutations = permutation_matrix_3(sub_matrix_size=3, width=6, height=6)
    ...
    def test_permutation_matrix_3_big(self):
        permutations = permutation_matrix_3(sub_matrix_size=10, width=20, height=20)
