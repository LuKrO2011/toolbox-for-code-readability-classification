...
[source,bash]
----
python src/readability_preprocessing/main.py CONVERT_CSV [-h] --input INPUT [INPUT ...] --output OUTPUT
                           [--percent-to-remove PERCENT_TO_REMOVE]
----
...
[source,bash]
----
python src/readability_preprocessing/main.py CONVERT_CSV -i <input_path_1> <input_path_2> -o <output_path>
----
